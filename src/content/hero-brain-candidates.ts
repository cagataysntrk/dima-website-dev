  ...
  candidates: [
    {
      ...
      source: l("Brain Project", "Brain Project"),
      license: "Apache-2.0 · model CC BY-SA 4.0",
    ...
    },
    {
      ...
      source: l("Neuronaut ışık düzeni + Brain Project modeli", "Neuronaut lighting + Brain Project model"),
      license: "MIT + Apache-2.0 · model CC BY-SA 4.0",
      modelUrl: "https://cdn.jsdelivr.net/gh/itayinbarr/brainproject@main/brain-atlas/models/brain.glb",
      dracoPath: "https://cdn.jsdelivr.net/gh/itayinbarr/brainproject@main/brain-atlas/vendor/draco/",
    },
    {
      ...
      source: l("NeuroSphere görünümü + Brain Project modeli", "NeuroSphere rendering + Brain Project model"),
      license: "MIT + Apache-2.0 · model CC BY-SA 4.0",
      modelUrl: "https://cdn.jsdelivr.net/gh/itayinbarr/brainproject@main/brain-atlas/models/brain.glb",
      dracoPath: "https://cdn.jsdelivr.net/gh/itayinbarr/brainproject@main/brain-atlas/vendor/draco/",
    },
