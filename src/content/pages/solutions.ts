export const solutionsPage = {
  ...
  loop: {
    title: {
      tr: "Bir bulgu nasıl karara dönüşür?",
      en: "How does a finding become a decision?",
    },
    intro: {
      tr: "Dima'nın farkı yalnız bir sinyal üretmesi değildir. Aynı şirket, varlık ve ilişki bağlamı araştırma boyunca korunur. Böylece kullanıcı her adımda yeniden veri toplamak veya hikâyeyi baştan kurmak zorunda kalmaz.",
      ...
      tr: [
        {
          ...
          body: "Veritabanı, ERP, Excel/CSV ve diğer kaynaklardan gelen tabloları yalnız aynı yerde toplamaz; müşteri, fatura, sipariş, makine, ürün ve ölçü gibi varlıkları ve aralarındaki ilişkileri Şirket Beyni bağlamına yerleştirir.",
        },
        {
        ...
        {
          title: "Önemli sinyali bulguya dönüştür",
          body: "Her değişim alarm değildir. Dima iş etkisi taşıyan sapma, risk veya fırsatı ilgili iş alanı, varlık ve ilişkilere bağlayarak incelenebilir bir bulgu olarak öne çıkarır.",
        },
        {
          title: "Nedeni kanıtlarıyla araştır",
          body: "Bulgunun arkasındaki varlık ve zaman ilişkilerini inceler; kök neden adaylarını karşılaştırır, elenen ihtimalleri ayırır ve sonucun dayandığı veri kaynaklarını görünür tutar.",
        },
        {
        ...
        {
          title: "Eylemi kontrollü yürüt, sonucu hafızaya bağla",
          body: "Uygun eylemler Taslak → Doğrula → Önizle → Onayla → Uygula → Kayıt zinciriyle ilerler. Yüksek etkili finans ve ERP işlemlerinde insan onayı ile denetim izi korunur. Sonuç daha sonra aynı varlık, bulgu ve karar varsayımına bağlanarak şirket hafızasını besler.",
        },
      ],
      en: [
        {
  ...
  trust: {
    ...
    points: {
      tr: [
        ...
        {
          title: "Kanıt bulgunun parçasıdır",
          body: "Kaynak, dönem, varlık, ilişki ve kullanılan hesaplar araştırmadan kopuk ayrı bir dipnot değildir; bulgunun neden dikkate alınması gerektiğinin parçasıdır.",
        },
        {
          title: "Bağlam konuşma boyunca kaybolmaz",
          body: "Sohbet kullanıldığında kullanıcı sıfırdan soru sormaz. Konuşma seçili bulgu, varlık ve araştırma bağlamının üzerinde devam eder; bu yüzden takip soruları aynı araştırmanın devamıdır.",
        },
        {
          title: "Eylem yetki, önizleme ve onayla sınırlıdır",
          body: "Dima'nın gelecekte daha fazla işi yürütmesi hedeflense de bugünkü marka vaadi sınırsız otonomi değildir. Kritik eylemler Taslak → Doğrula → Önizle → Onayla → Uygula → Kayıt zincirini, yüksek etkili işlemlerde insan onayını ve denetlenebilir kayıt izini korur.",
        },
      ],
      en: [
        {
