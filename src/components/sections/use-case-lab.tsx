      ...
      <Stack gap="loose">
        ...
        <div className="overflow-hidden rounded-[1.35rem] border border-outline bg-surface shadow-xl">
          ...
          <div className="grid lg:grid-cols-[minmax(0,1.45fr)_minmax(21rem,0.55fr)]">
            <div className="relative min-h-[34rem] overflow-hidden border-b border-hairline bg-raised lg:min-h-[40rem] lg:border-b-0 lg:border-r">
              <img
              ...
              <div className="absolute inset-x-4 bottom-4 sm:inset-x-6 sm:bottom-6">
                <div className="max-w-xl rounded-[1.1rem] border border-hairline bg-surface/95 p-4 shadow-xl backdrop-blur-xl sm:p-5">
            ...
            <aside className="flex min-h-[34rem] flex-col p-5 sm:p-6 lg:min-h-[40rem] lg:p-7">
              <div>
