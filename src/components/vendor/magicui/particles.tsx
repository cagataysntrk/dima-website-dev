/**
 * Magic UI "Particles" — MIT, https://magicui.design/r/particles. Vendored unchanged but for
 * the cn import; the wrapper (components/sections/cta-particles.tsx) decides when it may run.
 */
"use client"
...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  // Capped like the globe (home/globe.tsx): full DPR on a 3x phone is 9x the pixels
  // for dots nobody can tell apart. Resolved once per mount; zoom changes re-init canvas.
  const dpr = useRef(typeof window !== "undefined" ? Math.min(window.devicePixelRatio || 1, 1.5) : 1)
